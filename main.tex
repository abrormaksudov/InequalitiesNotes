...
\begin{tcolorbox}
    ...
    Example: $\textstyle a=1, b=2, c=3 \implies (\frac{ab + bc + ca}{3})^2 \geq (\frac{a+b+c}{3})abc \implies \left(\frac{1\cdot2 + 2\cdot3 + 3\cdot1}{3}\right)^2 \geq \frac{1+2+3}{3} (1\cdot2\cdot3) \implies \left(\frac{11}{3}\right)^2 \geq 2 \cdot 6 \implies 13.444 \geq 12$.
\end{tcolorbox}
...
\begin{tcolorbox}
    ...
    \]
    with equality if and only if $x_1 = x_2 = \dots = x_n$. \\[6pt]
    Example: $\textstyle a=1, b=2, c=3 \implies \frac{a+b+c}{3} \geq \sqrt{\frac{ab + bc + ca}{3}} \geq \sqrt[3]{abc} \implies \frac{1+2+3}{3} \geq \sqrt{\frac{1\cdot2 + 2\cdot3 + 3\cdot1}{3}} \geq \sqrt[3]{1\cdot2\cdot3} \implies 2 \geq \frac{11}{3} \geq \sqrt[3]{6} \implies 2 \geq 1.915 \geq 1.817$.
\end{tcolorbox}
